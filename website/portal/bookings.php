...
as_booking b  LEFT outer join as_users u on u.userIdTag=b.userIdTag inner join as_resturants r on b.resId=r.id  where b.resId= '$session_id' group by b.cartId order by b.id desc
"; 
