...
//total users
$query = "select count(userIdTag) as 'nUsers'
from   as_users
"; 
$result = $con->query($query); 
if ($result->num_rows > 0)
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title" id="nBookedRooms"><?echo $nFreeRooms?>                  </h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <p class="card-category">Total Resturants</p>
                  <h3 class="card-title" id="nExpiredRooms"><?echo $nBookedRooms?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                     Number of total resturants
                  </div>
                </div>
              </div>
            </div>
        ...
        var InitiateGetTransactions = function(textIdInp, callback) // How can I use this callback?
         {
             ...
             request.open("POST", "https://game.anomoz.com/api/allSet/post/read_live_resturant_bookings.php?resId=all");
             request.send();
         }
